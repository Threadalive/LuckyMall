...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    I.prototype.config = {
        ...
        var v = function (e) {
            var l = t(this), n = l.parents("tr").eq(0).data("templates.admin.index"), o = a.layBody.find('tr[data-index="' + n + '"]'),
                r = d.cache[a.key] || [];
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            ...
            var e = t(this).prev(), i = e[0].checked, l = d.cache[a.key], n = e.parents("tr").eq(0).data("templates.admin.index");
        ...
        a.layBody.on("change", "." + W, function () {
            var e = t(this), i = this.value, l = e.parent().data("field"), n = e.parents("tr").eq(0).data("templates.admin.index"),
                o = d.cache[a.key][n];
            o[l] = i, layui.event.call(this, y, "edit(" + p + ")", v.call(this, {value: i, field: l}))
        }).on("blur", "." + W, function () {
            var e, l = t(this), n = this, o = l.parent().data("field"), r = l.parents("tr").eq(0).data("templates.admin.index"),
                c = d.cache[a.key][r];
        ...
        a.layBody.on("click", "." + g, function (e) {
            ...
            var e = t(this), i = e.parents("tr").eq(0).data("templates.admin.index");
